...
export function HomeHero() {
	return (
		<section className='app-container grid min-h-[calc(100vh-5rem)] items-center gap-12 py-16 lg:grid-cols-[1.12fr_0.88fr] lg:py-24'>
			<div>
